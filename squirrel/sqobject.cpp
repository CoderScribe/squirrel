...
bool WriteObject(HSQUIRRELVM v,SQUserPointer up,SQWRITEFUNC write,SQObjectPtr &o)
{
    ...
    case OT_STRING:
        ...
        _CHECK_IO(SafeWrite(v,write,up,_stringval(o),sq_rsl(_string(o)->_len+1)));
        break;
    case OT_BOOL:
    case OT_INTEGER:
...
bool ReadObject(HSQUIRRELVM v,SQUserPointer up,SQREADFUNC read,SQObjectPtr &o)
{
    ...
    case OT_STRING:{
        ...
        _CHECK_IO(SafeRead(v,read,up,_ss(v)->GetScratchPad(sq_rsl(len + 1)),sq_rsl(len + 1)));
...
bool ReadObject(HSQUIRRELVM v,SQUserPointer *up,SQInteger dummy,SQObjectPtr &o)
{
	...
	case OT_STRING:{
		...
		*up = ((unsigned char*)*up) + (sq_rsl(len + 1));
				   }
		break;
	case OT_INTEGER:{
		SQInteger i;
